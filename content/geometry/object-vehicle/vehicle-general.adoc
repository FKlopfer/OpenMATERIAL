...
The vehicle's 3D geometry is structured according to the node structure defined in xref:../geometry/object-vehicle/vehicle-index.html#_model_structure[Model structure]. 
